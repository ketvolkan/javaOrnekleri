...
public class Main {
	...
	public static void main(String[] args) {
		...
		if(sayi1<sayi2)
		{
			System.out.println("sayi 1 Büyüktür dayýýýý");
		}
		else if(sayi1>sayi2)
		{
			System.out.println("sayi 2 Büyüktür dayýýýý");
		}
		else 
		{
			System.out.println("sayilar eþit dayýýýý");	
		}
		//dizi
		String[] isimler = {"Ali","Ýbrahim","Volkan","Nazmi","Mehmet","Ahmet"};
		//2boyutlu dizi
	...
	{	
		...
		{
			durum = "Arkadas Sayilar Deðiller";
		}
		return durum;
	}
